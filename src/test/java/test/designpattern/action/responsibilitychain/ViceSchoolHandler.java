 ...
 * @version v1.0
 * @author: TianXiang
 * @description: 副校长审批采购金额
 * @date: 2019/12/14
 */
public class ViceSchoolHandler extends Handler{

    public ViceSchoolHandler(String name) {
        super(name);
    }

    @Override
    public void processRequest(PurchaseRequest request) {
        if(request.getPirce() <= 30000 && request.getPirce() > 10000)
