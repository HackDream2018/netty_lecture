 ...
 * @date: 2019/11/24
 */
public class Wife extends Colleague{

    public Wife(Mediator mediator, String colleagueName) {
    ...
    protected void state0() {
         System.out.println("由中介者执行房东妻子0状态的任务");
    }
    protected void state1() {
         System.out.println("由中介者执行房东妻子1状态的任务");
    }
}
